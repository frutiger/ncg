...
class EmulatedProperties(Properties):
    def __init__(self, settings, category):
        self._settings = settings
        self._category = category

    def compile_flags(self, configuration_name, configuration):
        # TBD: should we call super(EmulatedProperties, self).compile_flags?
    ...
    def defines(self, configuration_name, configuration):
        defines = super(EmulatedProperties, self).defines(configuration_name, configuration)
